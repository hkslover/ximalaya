...
import random
#备用下载方案
#获取trackidhttps://www.ximalaya.com/revision/album/v1/getTracksList?albumId={}&pageNum=1
#trackTotalCount":除30取整+1（余数为0不加1）
#获取下载链接https://www.ximalaya.com/revision/play/v1/audio?id=7419091&ptype=1
columns1 = ("TITTLE","ID")
...
windows.title('喜马拉雅专辑下载4.0 BY:Snow')
